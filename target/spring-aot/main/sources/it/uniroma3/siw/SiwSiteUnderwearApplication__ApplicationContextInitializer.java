 ...
 */
@Generated
public class SiwSiteUnderwearApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SiwSiteUnderwearApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SiwSiteUnderwearApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "it.uniroma3.siw.config.SecurityConfig");
