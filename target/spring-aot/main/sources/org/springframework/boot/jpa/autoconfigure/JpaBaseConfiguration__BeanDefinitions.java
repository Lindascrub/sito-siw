...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("it.uniroma3.siw.model.Carrello", "it.uniroma3.siw.model.Categoria", "it.uniroma3.siw.model.Credenziali", "it.uniroma3.siw.model.Ordine", "it.uniroma3.siw.model.Prodotto", "it.uniroma3.siw.model.Recensione", "it.uniroma3.siw.model.RigaCarrello", "it.uniroma3.siw.model.RigaOrdine", "it.uniroma3.siw.model.Taglia", "it.uniroma3.siw.model.Utente");
